...
SRC_URI += "git://git.codelinaro.org/clo/le/platform/vendor/qcom-opensource/wlan/platform.git;protocol=https;rev=9a622c87a60b17063eed7d0388dfe26a324b3134;branch=wlan-platform.qclinux.1.0.r2-rel"
