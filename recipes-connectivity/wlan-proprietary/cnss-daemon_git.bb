...
def config_machine_flag(d):
    if d.getVar('PRODUCT', True) == 'ubuntu' and d.getVar('MACHINE', True) == 'qrb5165-rb5':
        return " --disable-cld80211-lib"
    else:
        return ""
...
EXTRA_OECONF += "${@config_machine_flag(d)}"
