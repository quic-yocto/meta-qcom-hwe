...
SRC_URI += "git://git.codelinaro.org/clo/le/platform/system/memory/libdmabufheap.git;protocol=https;rev=37bf33001a41b66676d6d1883982f0b14583fc02;branch=memory-le-apps.lnx.1.0.r35-rel"
