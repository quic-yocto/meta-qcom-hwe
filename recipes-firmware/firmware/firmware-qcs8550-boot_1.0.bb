...
QCM_BOOTBINARIES = "QCS8550_bootbinaries"
...
do_deploy() {
    ...
    install -D -m644 ${D}/*.melf ${DEPLOYDIR}
    install -D -m644 ${D}/*.fv ${DEPLOYDIR}
}
...
FILES:${PN} += "/*.elf /*.mbn /*bin /*.melf /*.fv"
FILES:${PN}-copyright += "/Qualcomm-Technologies-Inc.-Proprietary"
FILES:${PN}-partconf += "/partition.xml /partition_ext_efi_verification.xml"
