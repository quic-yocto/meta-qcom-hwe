...
SRC_URI += "git://git.codelinaro.org/clo/le/platform/vendor/qcom/opensource/tinycompress.git;protocol=https;rev=35a75aac61cd4962b2d96c7595e0af9f0ef282cc;branch=audio-tinylibs.lnx.1.0.r63-rel"
